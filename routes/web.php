...
Route::get('/about','HomeController@about_index')->name('about');
Route::get('/product','HomeController@product_index')->name('product');
Route::get('/blog','HomeController@blog_index')->name('blog');

Route::get('/instagram', 'InstagramPhotoController@index')->name('insta');
...
Route::resource('instagramphoto/instagram-photo', 'instagramphoto\InstagramPhotoController');
