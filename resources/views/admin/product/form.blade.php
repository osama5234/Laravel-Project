...
<div class="form-body">
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                <label for="">Rental Products</label>
                <select name="is_rental" id="rent" class="form-control">
                    <option {{ $product->is_rental == 1 ? 'selected' : '' }} value="1">Yes</option>
                    <option {{ $product->is_rental == 0 ? 'selected' : '' }} value="0">No</option>
                </select>
